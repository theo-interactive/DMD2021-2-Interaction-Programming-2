...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        const $radioListChildEls = $('#radio-list').children().length;
        console.log($radioListChildEls);
        ...
        */
        ...
        const $type2 = $('.type-2').parent().index();
        console.log($type2);
        ...
        */
        //Answer 10.
        let $radio = $('input[name="radio"]').not('#radio-2').parents();
        ...
        */
        //Answer 11.
        const $emphasis = $('li.sub-last').parents('.last').children('a').addClass('emphasis');
        const $bold =  $('li.sub-last').parents('.last').find('a').addClass('bold');
