...
(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        const $aType = $('a.type-2');
        $aType.addClass('curent');
        ...
        */
        //Answer 4.
        const $a = $('a').has('span').addClass('inner');
        ...
        */
        //Answer 5.
        const $liData = $('li[data-role="link"]').addClass('role');
        ...
        */
        ...
        const $radioLi = $('#radio-list').children().length;
        console.log($radioLi);
        ...
        */
        ...
        const $radio2 = $('input[type="radio"]').not('#radio-2');// radio-2가 아닌 input radio요소를 찾는 식 작성
        const $radioparent = $radio2.parent();// 부모노드 찾음
        const $radioparent2 = $radioparent.children('label');
        $radioparent2.addClass('emphasis');
        ...
        */
        ...
        const $sublast = $('li.sub-last');//sub-last 클래스를 가진 li요소
        const $last = $sublast.parent('.last');// 부모노드라고 했으니 parent 작성
        $last.children('a').addClass('emphasis');// 자식노드 a 요소들에 emphasis 클래스 추가
        $last.find('a').addClass('bold');// 모든이라고 했으니 find 작성
    });
})(jQuery);