...
(function($){
    $(document).ready(function(){
        ...
        */
        ...
        const $liData = $('li[data-role="link"]');
        ...
        */
        ...
        const $radioList = $('#radio-list').children().length;
        ...
        */
        ...
        const $radioIn2 = $('input[name="radio"]').not('#radio-2').parents();
        // 해당 요소의 자식 노드 label 요소에 emphasis 클래스 추가.
        $radioIn2.children('label').addClass('emphasis');
