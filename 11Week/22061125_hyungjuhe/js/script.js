    ...
    $(document).ready(function() {
        ...
        function animation2Start() {
            ...
            tl
                ...
                .to($section2Title, { y: 0, autoAlpha: 1, duration: 1, ease: 'sine.inOut' }, 'section2Start+=0.5')
                .to($section2Desc, { y: 0, autoAlpha: 1, duration: 1, ease: 'sine.inOut' }, 'section2Start+=0.8')
        }
