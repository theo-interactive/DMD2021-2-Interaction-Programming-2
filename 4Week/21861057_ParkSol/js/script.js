(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 1.
        $('<span id="my-name">‘제 이름은 박솔입니다.’</span>').appendTo('div#hello').eq(0);
        ...
        */
        //Answer 3.
        $('p.move-top').prependTo($('body').eq(0));
        ...
        */
        //Answer 4.
        $('p.move-bottom').appendTo($('body').eq(0));
        ...
        */
        ...
        let $width = 100;
        let $limitWidth = 500;
        const $btnBox = $('div.box-1');
        $btnBox.css('width',$width+'px');
