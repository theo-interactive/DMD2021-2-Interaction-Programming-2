(function($){
    $(document).ready(function(){
        ...
        */
        ...
        $('<span class="my-name">‘제 이름은 배정현입니다.’</span>').appendTo($divHello).eq(0);
        ...
        */
        //Answer 8.
        const $list_1 = $('ul.list-1').children('li').eq(0);
        for(let i = 4; i > 1; i--) {
            $list_1.after(`<li>리스트 ${i}</li>\n`);
        }
        ...
        */
        //Answer 9.
        const $list_2 = $('ul.list-2').children('li').eq(0);
        for(let i = 1; i <= 4; i++) {
            $list_2.before(`<li>리스트 ${i}</li>\n`);
        }
        ...
        */
        //Answer 10.
        const $Btn_1 = $('button.btn-1');
        const $Box_1 = $('div.box-1');
        let $width = 100;
        let $widthMax = 500;
        // let $widthMin = 0;
