(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 3.
        let $bannerCont = $('.banner-container');
        const $bannerItem = $('.banner-item');
        $bannerCont.css({
            'width': $bannerItem.length*$bannerWidth,
            'height' : '100%'
        });
        ...
        */
        //Answer 5.
        $bannerItem.find('img').css('width','100%');
        ...
        */
        ...
        $paddleNav.find('.arrow.prev').css('left','18px');
        /*
        Quest 7.
        .paddle-nav 의 자식노드 .arrow.next 노드의 right 속성을 18px 로 지정합니다.
        */
        //Answer 7.
        $paddleNav.find('.arrow.next').css('right','18px');
        ...
        */
        //Answer 9.
        // const position = $bannerCont.position();
        // const {top:posY, left:posX} = $bannerCont.position();

        let _id = 0;
        const slideLeft = function(){
            _id+=$bannerWidth;
            $bannerCont.animate({'right' : _id}, 
            function(){
                paddleCheck();
                dotSelect();
            });
       ...
       $paddleNav.find('.arrow.next').on('click',slideLeft);
       $paddleNav.find('.arrow.prev').on('click',slideRight);
