(function($){
    $(document).ready(function(){
        ...
        */
        //Answer 2.
        $('.banner-wrap').css('width', $('.banner').width());
        $('.banner-wrap').css('height', $('.banner').height());
        ...
        */
        ...
        $bannerContainer.css({
            'width': $bannerWrapWidth*$bannerItem.length,
            'height': '100%'
        });
        ...
        */
        //Answer 6.
        const $arrowPrev = $('.paddle-nav').find('.arrow.prev');
        ...
        */
        //Answer 7.
        const $arrowNext = $('.paddle-nav').find('.arrow.next');
        ...
        */
        ...
        const dotSelect = function(){
            if (_id == 0){
                ...
                $('.dot-nav').find('span').eq(0).addClass('selected');
            }else if (_id == 1000){
                $('span').removeClass('selected');
                $('.dot-nav').find('span').eq(1).addClass('selected');
            }else if (_id == 2000){
                $('span').removeClass('selected');
                $('.dot-nav').find('span').eq(2).addClass('selected');
            }else if (_id == 3000){
                $('span').removeClass('selected');
                $('.dot-nav').find('span').eq(3).addClass('selected');
            }
