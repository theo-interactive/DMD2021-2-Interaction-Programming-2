(function($){
    $(document).ready(function(){
        ...
        */
        ...
        let $banner_container = $('banner-container');
        let $banner_wrap = $('banner-wrap').width();
        let $banner_item = $('banner-item').length;

        $banner_container.css({

            'width' : $banner_wrap * $banner_item,
            'height' : '100%'
...
/*
        ...
        let $9banneritemwidth = $banner_item.width();
...
/*
        const paddleCheck = function(){
            ...
            12번, 13번 문제를 제대로 이해하지 못했습니다 ㅠㅠ 죄송합니다
        }
*/
